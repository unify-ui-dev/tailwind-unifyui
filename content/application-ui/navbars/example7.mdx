    ...
    <nav
        ...
        <div data-navbar
            ...
            <ul
                ...
                <li class="">
                    <a href="#" class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Features</a>
                </li>
                <li class="">
                    <a href="#" class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Company</a>
                </li>
                <li class="">
                    <a href="#"
                ...
                <li class="">
                    <a href="#" class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Contact</a>
                </li>
            </ul>
            <div class="flex flex-col sm:flex-row sm:items-center gap-4  lg:min-w-max mt-10 lg:mt-0">
                <a href="#"
                    class="h-10 flex items-center justify-center w-full sm:w-max rounded-full px-5 border border-gray-200 dark:border-gray-800 text-purple-600 dark:text-gray-300">
                    Login
                </a>
                <a href="#"
                    class="h-10 flex items-center justify-center w-full sm:w-max rounded-full px-5 bg-purple-600 text-white">
                    Sign-up
                </a>
            </div>
        </div>
