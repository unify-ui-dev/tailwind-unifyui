---
title: Feature Section (7)
category: marketing-ui
subCategory: features_services
previewUrl: /features_services/7/
info: Require JS
---
    ...
    <section class="py-32">
        <div class="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
            <div class="flex flex-col  space-y-16">
                <div class="flex flex-col justify-center text-center  mx-auto md:max-w-2xl space-y-5">
                    <span class="rounded-lg bg-blue-100 dark:bg-gray-900 px-2.5 py-1 text-xs w-max mx-auto font-semibold tracking-wide text-purple-800 dark:text-gray-100">Features</span>
                ...
                <div class="grid divide-y divide-gray-300/60 dark:divide-gray-800/30 gap-12 children:py-5 first:pt-0 last:pb-0">
                    <div class="flex flex-col md:items-center md:flex-row gap-10 lg:gap-14">
                        <div class="md:w-[48%] xl:w-[45%] md:py-6 xl:py-12 space-y-8">
                            <div class="space-y-6">
                                <span class="p-2 rounded-md bg-purple-100 text-purple-700 dark:bg-gray-900 dark:text-purple-500 flex w-max">
                                    <!-- feature icon -->
                                ...
                                <p class="text-gray-700 dark:text-gray-300">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae odio consequatur aliquam ratione 
                                </p>
                            </div>
                            <ul role="list" class="space-y-5 children:flex children:items-start children:gap-4 children:text-gray-600 dark:children:text-gray-400">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 fill-purple-600 dark:fill-purple-500">
                        ...
                        p-6 rounded-lg aspect-[4/2.4] overflow-hidden">
                            <img src="/images/dash-light.webp" alt="illustration" width="1800" class="w-full h-auto">
                        </div>
                    </div>

                    <div class="flex flex-col md:items-center md:flex-row-reverse gap-10 lg:gap-14">
                        <div class="md:w-[48%] xl:w-[45%] md:py-6 xl:py-12 space-y-8">
                            <div class="space-y-6">
                                <span class="p-2 rounded-md bg-purple-100 text-purple-700 dark:bg-gray-900 dark:text-purple-500 flex w-max">
                                    <!-- feature icon -->
                                ...
                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    Cross-plateforme based app, compatible with all Devices
                                </h2>
                                <p class="text-gray-700 dark:text-gray-300">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae odio consequatur aliquam ratione 
                                </p>
                            ...
                            <ul role="list" class="space-y-5 children:flex children:items-start children:gap-4 children:text-gray-600 dark:children:text-gray-400">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="w-5 h-5 fill-purple-600 dark:fill-purple-500">
                                        <path fill-rule="evenodd" d="M16.403 12.652a3 3 0 000-5.304 3 3 0 00-3.75-3.751 3 3 0 00-5.305 0 3 3 0 00-3.751 3.75 3 3 0 000 5.305 3 3 0 003.75 3.751 3 3 0 005.305 0 3 3 0 003.751-3.75zm-2.546-4.46a.75.75 0 00-1.214-.883l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                                    </svg> 
                                    Advantage of this feature                                         
                                </li>
                        ...
                        <div class="flex-1 relative bg-gradient-to-tr from-sky-100 to-indigo-300 
                        p-6 rounded-lg aspect-[4/2.4] overflow-hidden">
                            <img src="/images/dash-dark.webp" alt="illustration" width="1800" class="w-full h-auto">
                        </div>
                    </div>
                    <div class="flex flex-col md:items-center md:flex-row gap-10 lg:gap-14">
                        <div class="md:w-[48%] xl:w-[45%] md:py-6 xl:py-12 space-y-8">
                            <div class="space-y-6">
                                ...
                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    Stay sync, work without internet and then sync your data after
                                </h2>
                                <p class="text-gray-700 dark:text-gray-300">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae odio consequatur aliquam ratione 
                                </p>
    ...
    return (
        <div className={`flex flex-col md:items-center gap-10 lg:gap-14 ${id%2===0? "md:flex-row" :"md:flex-row-reverse"}`}>
            ...
            <div className="flex-1 relative bg-gradient-to-tr from-sky-100 to-indigo-300 
                      p-6 rounded-lg aspect-[4/2.4] overflow-hidden">
                <img src={image} alt="illustration" width={1800} className="w-full h-auto" />
            </div>
        </div>
    )
}
            ...
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
                <div className="flex flex-col  space-y-16">
                    <div className="flex flex-col justify-center text-center  mx-auto md:max-w-2xl space-y-5">
                        <span className="rounded-lg bg-blue-100 dark:bg-gray-900 px-2.5 py-1 text-xs w-max mx-auto font-semibold tracking-wide text-purple-800 dark:text-gray-100">Features</span>
...
const FeatureItem = ({ id, title, description, advantages, icon, image }) => {
    return (
        <div className={`flex flex-col md:items-center gap-10 lg:gap-14 ${id%2===0? "md:flex-row" :"md:flex-row-reverse"}`}>
            ...
            <div className="flex-1 relative bg-gradient-to-tr from-sky-100 to-indigo-300 
                      p-6 rounded-lg aspect-[4/2.4] overflow-hidden">
                <Image src={image} alt="illustration" width={1800} className="w-full h-auto" />
            </div>
        </div>
    )
}
