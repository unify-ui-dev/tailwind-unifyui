...
<section class="py-24">
    <div class="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
        ...
        <div class="md:w-1/2 lg:w-[54%] space-y-12 text-gray-700 dark:text-gray-300">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="space-y-6 p-4 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900">
                    <span class="rounded-full bg-gray-900 dark:bg-gray-100 text-gray-100 dark:text-gray-900 w-max p-3 flex">
                    ...
                    <h2 class="font-semibold text-xl text-gray-900 dark:text-white">Our mission</h2>
                    <p>
                ...
                <div class="space-y-6 p-4 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-900">
                    ...
                    <h2 class="font-semibold text-xl text-gray-900 dark:text-white">Our vision</h2>
                    <p>
                        Lorem ipsum dolor sit amet consectetur
                    </p>
                </div>
