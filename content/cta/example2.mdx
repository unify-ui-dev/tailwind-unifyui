        ...
        <div
            ...
            <div class="absolute right-0 top-0 h-full w-full flex justify-end">
                <div class="w-28 h-28 overflow-hidden flex rounded-xl relative blur-2xl">
                    <span class="absolute w-16 h-16 -top-1 -right-1 bg-blue-500 rounded-md rotate-45"></span>
            ...
            <div class="mx-auto text-center max-w-xl md:max-w-2xl relative space-y-8">
                <h1 class="text-3xl/tight sm:text-4xl/tight md:text-5xl/tight font-bold text-blue-950 dark:text-white">
                    Quick Start your <span class="text-transparent bg-clip-text bg-gradient-to-br from-blue-600 from-20% via-indigo-400 via-30% to-teal-600">Strategic Digital</span> Marketing Campaing
                </h1>
