...
<UnifyTab values={["html","reactjs","nextjs"]}>
    ...
    ```html
        ...
        <div class="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 grid grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-16 py-20">
            ...
            <div class="space-y-6">
                <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Links</h1>
                <ul class="space-y-3">
                    <li>
                    ...
                    <li>
                        <a href="#" class="duration-200 hover:text-blue-600 dark:hover:text-blue-500">Portfolio</a>
                    </li>
                    <li>
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="#" class="duration-200 hover:text-blue-600 dark:hover:text-blue-500">Carreer</a>
                    </li>
                </ul>
            </div>
            <div class="space-y-6 col-span-2">
                <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">News-letter</h1>
                <form class="w-full max-w-2xl flex flex-col sm:flex-row gap-3">
                    <input type="email" placeholder="johndoe@gmail.com" class="px-5 py-2.5 rounded-md outline-none flex-1 bg-gray-200 dark:bg-gray-800">
                    <button class="outline-none w-full py-2.5 px-5 sm:w-max bg-blue-600 text-white rounded-md flex items-center justify-center">
                        Subscribe
                    </button>
                </form>
            </div>
