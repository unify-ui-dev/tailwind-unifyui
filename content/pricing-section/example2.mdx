                ...
                <div class="flex gap-10 flex-col items-center">
                    ...
                    <div class="min-w-max flex justify-center md:justify-end">
                        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-lg shadow-gray-200/40 dark:shadow-none flex items-center relative p-1">
                            ...
                            <button class="text-gray-700 dark:text-gray-300 flex items-center h-9 w-max px-4">
                                Yearly
                            </button>
                        </div>
                    </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 mx-auto">
                    <div class="rounded-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 p-6 sm:p-10 space-y-6">
                        ...
                        <div class="flex justify-center">
                            <a href="#" class="outline-none w-max flex items-center mx-auto h-11 px-5 rounded-md bg-gray-100 dark:bg-gray-900 text-blue-700 dark:text-gray-300">
                                Get Started
                            </a>
                        </div>
                    </div>
                    <div class="rounded-lg relative border border-gray-100 dark:border-gray-900 bg-gray-100 dark:bg-gray-900 p-6 sm:p-10">
                        <div class="absolute top-0 left-1/2 -translate-x-1/2 px-3 py-1 rounded-b-lg bg-gray-200 dark:bg-gray-950 text-gray-700 dark:text-gray-300">
                            Recommanded
                        </div>
                        <div class="space-y-6">
                            <div class="text-center space-y-3">
                            ...
                            <div class="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-200 dark:before:bg-gray-800"></div>
                            <div class="flex justify-center">
                                <a href="#" class="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-blue-900 dark:bg-blue-950 text-white">
                                    Get Started
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="rounded-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 p-6 sm:p-10 space-y-6">
                        ...
                        <div class="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-100 dark:before:bg-gray-900"></div>
                        <div class="flex justify-center">
                            <a href="#" class="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-gray-100 dark:bg-gray-900 text-blue-700 dark:text-gray-300">
                                Get Started
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 mx-auto">
                        ...
                        <div className="rounded-lg relative border border-gray-100 dark:border-gray-900 bg-gray-100 dark:bg-gray-900 p-6 sm:p-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-200 dark:before:bg-gray-800" />
                                <div className="flex justify-center">
                                    <Link href="#" className="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-blue-900 dark:bg-blue-950 text-white">
                                        Get Started
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className="rounded-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 p-6 sm:p-10 space-y-6">
                            ...
                            <div className="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-100 dark:before:bg-gray-900" />
                            <div className="flex justify-center">
                                <Link href="#" className="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-gray-100 dark:bg-gray-900 text-blue-700 dark:text-gray-300">
                                    Get Started
                                </Link>
                            </div>
                        </div>
