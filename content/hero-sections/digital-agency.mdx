...
previewUrl: /hero-sections/digital-agency/
info: Require JS
---
...
<header class="absolute inset-x-0 top-0 z-50 py-6">
    <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
        <nav class="w-full flex justify-between gap-6 relative">
            <div class="min-w-max inline-flex relative">
                <a href="/" class="relative flex items-center gap-3">
                    <div class="relative w-7 h-7 overflow-hidden flex rounded-xl">
                        ...
                        <span
                            class="absolute w-2 h-2 rounded-full bg-gray-900 dark:bg-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></span>
                    </div>
            ...
            <div data-navbar
                class="flex invisible opacity-0  translate-y-10 overflow-hidden lg:visible lg:opacity-100  lg:-translate-y-0 duration-300 ease-linear flex-col gap-y-6 gap-x-4 lg:flex-row w-full lg:justify-between lg:items-center absolute lg:relative top-full lg:top-0 bg-white dark:bg-gray-950 lg:!bg-transparent border-x border-x-gray-100 dark:border-x-gray-900 lg:border-x-0">
                <ul
                    class="border-t border-gray-100 dark:border-gray-900 lg:border-t-0 px-6 lg:px-0 pt-6 lg:pt-0 flex flex-col lg:flex-row gap-y-4 gap-x-3 text-lg text-gray-700 dark:text-gray-300 w-full lg:justify-center lg:items-center">
                    <li>
                ...
                <div
                    class="lg:min-w-max flex items-center sm:w-max w-full pb-6 lg:pb-0 border-b border-gray-100 dark:border-gray-900  lg:border-0 px-6 lg:px-0">
                    <a href="#"
            ...
            <div class="min-w-max flex items-center gap-x-3">
                <button data-switch-theme
                    class="outline-none flex relative text-gray-700 dark:text-gray-300 rounded-full p-2 lg:p-3 border border-gray-100 dark:border-gray-900 ">
                ...
                <button data-toggle-navbar data-is-open="false"
                    ...
                    <span id="line-1"
                        class="w-6 h-0.5 rounded-full bg-gray-700 dark:bg-gray-300 transition-all duration-300 ease-linear"></span>
                    <span id="line-2"
                        class="w-6 origin-center  mt-1 h-0.5 rounded-ful bg-gray-700 dark:bg-gray-300 transition-all duration-300 ease-linear"></span>
                    <span id="line-3"
                        class="w-6 mt-1 h-0.5 rounded-ful bg-gray-700 dark:bg-gray-300 transition-all duration-300 ease-linear"></span>
...
export default function HeroSection() {
    return (
       ...
       font-bold text-gray-900 dark:text-white">
                    ...
                    <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                        <Image src="/images/image1.webp" alt="Hero image" width={2350} height={2359} className="lg:absolute lg:w-full lg:h-full rounded-3xl object-cover lg:max-h-none max-h-96" />
                    </div>
                </div>
            </section>
        </>
