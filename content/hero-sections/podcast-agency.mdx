---
title: Podcast Agency Website Hero Section
...
-->
    ...
    <header data-sticky-nav class="absolute inset-x-0 top-0 h-20 flex items-center z-50">
        <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative z-50">
            <nav class="flex items-center justify-between w-full relative">
                <div class="inline-flex relative bg-inherit">
                    <a href="#" class="flex items-center gap-2">
                        <span class="flex">
                            <span class="w-3 h-6 rounded-l-full flex bg-emerald-500"></span>
                ...
                <div data-navbar
                    class="absolute top-10 px-5 sm:px-8 md:px-12 lg:z-auto
                    lg:px-0 lg:pt-0 lg:top-0 invisible opacity-20 lg:opacity-100 translate-y-6
                    ...
                    w-full lg:justify-between py-6 lg:py-0 lg:visible lg:relative flex flex-col lg:flex-row transition-all duration-300 ease-linear origin-top lg:translate-y-0">
                    <ul
                        class="text-gray-700 dark:text-gray-100 w-full flex lg:items-center gap-y-4 lg:gap-x-8 flex-col lg:flex-row lg:w-full lg:justify-center">
                        <li>
                            <a href="#" class="transition hover:text-emerald-500 ease-linear text-lg">Podcast</a>
                        </li>
                        <li>
                            <a href="#" class="transition hover:text-emerald-500 ease-linear text-lg">Solution</a>
                        </li>
                        <li>
                            <a href="#" class="transition hover:text-emerald-500 ease-linear text-lg">Blog</a>
                        </li>
                        <li>
                            <a href="#" class="transition hover:text-emerald-500 ease-linear text-lg">About</a>
                        </li>
                    </ul>
                    <div
                        class="lg:min-w-max flex flex-col lg:flex-row lg:items-center gap-4 mt-8 lg:mt-0 w-full sm:w-max">
                        <a href="#"
                            class="px-7 relative text-emerald-500 h-12 flex w-full sm:w-max justify-center items-center before:bg-emerald-500/5 dark:before:bg-emerald-500/10 before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95">
                            <span class="relative text-emerald-500">Signin</span>
                        </a>

                        <a href="#"
                            class="px-7 relative text-white h-12 flex w-full sm:w-max justify-center items-center before:bg-emerald-500 before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95">
                            <span class="relative text-white"> Join Us</span>
                        </a>
                    </div>
                </div>
                <div class="flex ml-2 pl-2 border-l border-gray-100 dark:border-gray-800 min-w-max items-center gap-x-3">
                    <button data-switch-theme class="outline-none flex relative text-gray-700 dark:text-gray-300 p-3">
                    ...
                    <button data-toggle-navbar data-is-open="false" aria-label='toggle navbar'
                        class="outline-none lg:hidden w-7 h-auto flex flex-col relative children:flex">
                        <span aria-hidden="true" id="line-1"
                            class="w-6 origin-right scale-x-75 h-0.5 rounded-full bg-gray-700 dark:bg-gray-200 transition-all duration-300 ease-linear">
                        </span>
                        <span aria-hidden="true" id="line-2"
                            class="w-6 origin-center mt-1 h-0.5 rounded-full bg-gray-700 dark:bg-gray-200 transition-all duration-300 ease-linear">
                        </span>
                        <span aria-hidden="true" id="line-3"
                            class="w-6 origin-right scale-x-50 mt-1 h-0.5 rounded-full bg-gray-700 dark:bg-gray-200 transition-all duration-300 ease-linear">
                        </span>
                    </button>
                </div>
            </nav>
            ...
            <div
                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <span class="px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
                            New season available <a href="#"
                                class="underline text-emerald-700 dark:text-white font-semibold">here</a>
                        </span>
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mt-8 text-center lg:text-left mx-auto max-w-xl">
                    ...
                    <div class="flex items-center gap-4 mt-8 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <a href="#"
                            class="px-7 relative text-emerald-500 h-12 flex w-full sm:w-max justify-center items-center before:bg-emerald-500/5 dark:before:bg-emerald-500/10 before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95">
                            <span class="relative text-emerald-500 flex items-center gap-x-3">
                    ...
                    <div
                        ...
                        <div class="flex items-center -space-x-2">
                            <img src="/images/sidebiew.webp" width="1240" alt="avatar"
                                class="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover">
                            <img src="/images/sidebiew.webp" width="1240" alt="avatar"
                                class="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover">
                            <img src="/images/sidebiew.webp" width="1240" alt="avatar"
                                class="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover">
                            <img src="/images/sidebiew.webp" width="1240" alt="avatar"
                                class="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover">
                            <span
                                class="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 bg-gray-200 dark:bg-gray-800 text-xs text-gray-700 dark:text-gray-300 flex items-center justify-center">
                                300+
                            </span>
                        </div>
                        <span class="pl-2 text-gray-600 dark:text-gray-200"> WordWide listners </span>
                    </div>
                </div>
                            ...
                            <ul className="text-gray-700 dark:text-gray-100 w-full flex lg:items-center gap-y-4 lg:gap-x-8 flex-col lg:flex-row lg:w-full lg:justify-center">
                                {
                                    navItems.map(navItem => (
                                        <li key={navItem.id}>
                                            <Link href={navItem.link} className="transition hover:text-emerald-500 ease-linear text-lg">{navItem.text}</Link>
                                        </li>
                                    ))
                                }
                            </ul>
                            <div className="lg:min-w-max flex flex-col lg:flex-row lg:items-center gap-4 mt-8 lg:mt-0 w-full sm:w-max">
                                <Link href="#" className="px-7 relative text-emerald-500 h-12 flex w-full sm:w-max justify-center items-center before:bg-emerald-500/5 dark:before:bg-emerald-500/10 before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95">
                                    <span className="relative text-emerald-500">Signin</span>
                                </Link>
                                <Link href="#" className="px-7 relative text-white h-12 flex w-full sm:w-max justify-center items-center before:bg-emerald-500 before:absolute before:inset-0 before:rounded-full before:transition-transform before:ease-linear hover:before:scale-105 active:before:scale-95">
                                    <span className="relative text-white"> Join Us</span>
                                </Link>
                            </div>
                        </div>
                ...
                <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                        <div className="lg:py-6">
                            <div className="text-center lg:text-left">
                                <span className="px-2 py-1 rounded-md bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
                                    New season available <Link href="#" className="underline text-emerald-700 dark:text-white font-semibold">here</Link>
                                </span>
                                <h1 className="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                                    Find and listen <br /> Favorite
                                    <span className="text-transparent bg-clip-text bg-gradient-to-br from-emerald-500 to-[#8cd66a]">
                        ...
                        <div className="lg:h-full hidden md:flex">
                            <div className="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                                ...
                                <div className="absolute w-3/5 h-full z-10 p-1 -translate-y-1/2 top-1/2 right-3 rounded-3xl bg-whitee dark:bg-gray-950  shadow-lg shadow-gray-100 dark:shadow-transparent  border border-gray-200 dark:border-gray-800">
                                    <Image src="/images/sidebiew.webp" alt="In studio" width={900} height={900} loading="lazy" className="w-full h-full rounded-2xl object-cover" />
                                </div>
                                <div className="absolute -translate-y-1/2 top-1/2 h-[calc(80%-2rem)] w-[calc(40%-20px)] p-1 rounded-3xl bg-white dark:bg-gray-950  shadow-lg shadow-gray-100 dark:shadow-transparent  border border-gray-200 dark:border-gray-800">
                                    <Image src="/images/sidebiew.webp" alt="Happy in studio" width={900} height={900} loading="lazy" className="w-full h-full rounded-2xl object-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
