...
<header class="sticky left-0 top-0 w-full flex items-center h-20 bg-white border-b border-b-gray-200 dark:bg-gray-950 dark:border-b-gray-800 z-40">
    <nav class="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
        <div  class="w-full flex items-center lg:hidden">
            <button aria-label="toggle navbar" data-toggle-navbar data-is-open="false" class="outline-none border-r border-r-gray-200 dark:border-r-gray-800 pr-3 relative py-3 children:flex">
        ...
        <div data-navbar class="absolute top-full left-0 bg-white  dark:bg-gray-950 dark:lg:bg-transparent lg:flex w-full invisible lg:visible lg:opacity-100 opacity-0 ease-linear duration-300
            lg:relative lg:bg-transparent border-b border-b-gray-200 dark:border-b-gray-800 lg:border-b-0">
            <ul class=" px-5 sm:px-10 md:px-12 lg:px-0 flex flex-col lg:flex-row lg:items-center gap-y-6 lg:gap-x-5 text-gray-700 dark:text-gray-300 py-4 lg:py-0">
                <li>
                    <a href="#" class="relative py-3 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:rounded-lg after:bg-gray-600 after:w-4">
                        Home
                    </a>
                </li>
                <li>
                    <a href="#" class="relative py-3 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:rounded-lg after:bg-transparent">
                        Portfolio
                    </a>
                </li>
                <li>
        ...
        <div class="flex items-center flex-1">
            <a href="#" class="flex items-center gap-x-0.5 text-gray-800 dark:text-gray-200">
                <span class="bg-gray-700 dark:bg-gray-800 text-white px-4 py-1.5 rounded-lg">R</span>
                <span aria-hidden="true" class="hidden sm:flex">doe</span>
            </a>
        </div>
        <div class="flex justify-end items-center gap-x-1.5 sm:gap-x-2 w-full text-gray-700 dark:text-gray-300">
            <a href="#" target="_blank" class="duration-200 ease-linear hover:text-gray-800 dark:hover:text-gray-100">
...
<section class="py-8 ">
    <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
        <div class="mx-auto text-center max-w-xl">
            <h1 class="relative font-semibold max-w-max mx-auto pb-2 font-display text-3xl sm:text-4xl md:text-5xl text-gray-800 dark:text-white after:absolute
            after:bottom-0 after:left-0 after:h-0.5 after:rounded-lg after:bg-gray-800 dark:after:bg-gray-100 after:w-4">
                Roy Doe doe
            </h1>
        </div>
        <div class="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-14 gap-y-8 md:items-end">
            <div class="space-y-4 md:space-y-6 md:col-span-2 lg:col-span-1 w-full max-w-3xl lg:max-w-none mx-auto lg:mx-0 text-center lg:text-left">
                <h1 class="font-display font-semibold text-2xl md:text-3xl text-gray-900 dark:text-white">
                    Web designer based in Lubumbashi-DRC
                </h1>
                <div class="text-gray-700 dark:text-gray-300 space-y-3 mx-auto max-w-2xl lg:max-w-none">
                ...
                <div class="flex justify-center lg:justify-start">
                    <a href="#" class="px-6 h-11 flex items-center rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-sm transition ease-linear hover:bg-gray-900">Hire me</a>
                </div>
                <div class="grid grid-cols-3 w-full">
                    <div class="">
                        <h2 class="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">2years</h2>
                        <span class="text-gray-600">Experience</span>
                    </div>
                    <div class="">
                        <h2 class="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">+10</h2>
                        <span class="text-gray-600">Projects</span>
                    </div>
                    <div class="">
                        <h2 class="text-xl md:text-2xl font-display font-semiboldtext-gray-800 dark:text-gray-200">90%</h2>
            ...
            <div class="flex justify-center">
                <div class="max-w-full relative">
                    <span class="absolute inset-x-0 top-16 bottom-0 rounded-lg scale-[1.04]  bg-gradient-to-b from-gray-200 dark:from-gray-900"></span>
                    <span class="absolute inset-x-0 bottom-0 top-16 rounded-lg bg-gray-100 dark:bg-gray-900"></span>
                    <img src="/images/dev-with-c.webp" width="1240" height="1376" alt="Developer with laptop smile" class="relative w-full h-auto max-h-96 lg:max-h-[26rem]">
                </div>
            </div>
            <div class="space-y-3 lg:space-y-6">
                <div class="flex items-start gap-x-2 p-2 md:p-3 lg:p-4 bg-gray-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                    <span class="min-w-max text-gray-600 p-2 md:p-3 rounded-lg bg-gray-200 dark:bg-gray-800 border border-gray-100/70 dark:border-gray-900/70 dark:text-gray-200">
                    ...
                    <div>
                        <span class="font-semibold text-gray-800  dark:text-gray-200 text-lg">Smart Skills</span>
        ...
        <>
            ...
            <header className="sticky left-0 top-0 w-full flex items-center h-20 bg-white border-b border-b-gray-200 dark:bg-gray-950 dark:border-b-gray-800 z-40">
                <nav className="relative mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex gap-x-5 justify-between items-center">
                    ...
                    <div className="flex justify-end items-center gap-x-1.5 sm:gap-x-2 w-full text-gray-700 dark:text-gray-300">
                        <a href="#" target="_blank" className="duration-200 ease-linear hover:text-gray-800 dark:hover:text-gray-100" rel='noreferer'>
                            <span className="sr-only">facebook</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" className="w-5 h-5" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                            </svg>
                    ...
                    <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-14 gap-y-8 md:items-end">
                        ...
                        <div className="flex justify-center">
                            <div className="max-w-full relative">
                                <span className="absolute inset-x-0 top-16 bottom-0 rounded-lg scale-[1.04]  bg-gradient-to-b from-gray-200 dark:from-gray-900" />
                                <span className="absolute inset-x-0 bottom-0 top-16 rounded-lg bg-gray-100 dark:bg-gray-900" />
                                <Image src="/images/dev-with-c.webp" width={1240} height={1376} alt="Developer with laptop smile" className="relative w-full h-auto max-h-96 lg:max-h-[26rem]" />
                            </div>
                        </div>
                        <div className="space-y-3 lg:space-y-6">
                            <div className="flex items-start gap-x-2 p-2 md:p-3 lg:p-4 bg-gray-50 dark:bg-gray-900 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
