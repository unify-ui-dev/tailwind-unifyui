...
previewUrl: /hero-sections/saas-product/
info: Require JS
---
    ...
    <nav
        ...
        <div class="flex items-center min-w-max relative">
            <a href="#" class="font-semibold flex items-center gap-x-2">
                ...
                <span class="text-lg text-gray-700 dark:text-gray-300">mySto</span>
            </a>
        </div>
        ...
        <div data-navbar
            ...
            <ul
                class="flex flex-col lg:flex-row gap-6 lg:items-center text-gray-700 dark:text-gray-300 lg:w-full lg:pl-10">
                <li class="">
                    <a href="#"
                        class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Features</a>
                </li>
                <li class="">
                    <a href="#"
                        class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Company</a>
                </li>
                <li class="">
                    <a href="#"
                        class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Plateform</a>
                </li>
                <li class="">
                    <a href="#"
                        class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Resources</a>
                </li>
                <li class="">
                    <a href="#"
                        class="relative py-2.5 duration-300 ease-linear hover:text-purple-600 ">Contact</a>
                </li>
            </ul>
            <div
                class="flex flex-col sm:flex-row sm:items-center gap-4  lg:min-w-max mt-10 lg:mt-0">
                <a href="#" class="h-10 flex items-center justify-center w-full sm:w-max rounded-full px-5 border border-gray-200 dark:border-gray-800 text-purple-600 dark:text-gray-300">
                    Login
                </a>
                <a href="#" class="h-10 flex items-center justify-center w-full sm:w-max rounded-full px-5 bg-purple-600 text-white">
                    Sign-up
                </a>
            </div>
        </div>
...
<section class="min-h-max bg-purple-50 dark:bg-gray-950">
    <div class="absolute top-0 inset-x-0 h-40 bg-gradient-to-br from-purple-300 opacity-90 blur-lg dark:from-purple-800 dark:blur-xl dark:opacity-40"></div>
    <div class="w-full flex items-center relative">
        <div class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-2/5 aspect-[2/0.5] bg-gradient-to-br from-purple-600 to-pink-400 rounded-full opacity-50 blur-2xl"></div>
        <div class="min-h-max relative mx-auto pt-32 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
            <a href="#" class="flex items-center gap-x-2 text-gray-900 dark:text-gray-100 mx-auto w-max px-2 pr-1 py-1 rounded-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-800">
                mySto v2.1 is out
                <span class="px-1 rounded-full bg-gray-200 dark:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                    </svg>                          
                </span>
            </a>
            <h1 class="text-gray-900 dark:text-white mx-auto max-w-5xl font-semibold text-4xl/tight sm:text-5xl/tight lg:text-6xl/tight">
            ...
            <div class="mx-auto max-w-6xl rounded-t-2xl aspect-[5/2.3] overflow-hidden px-2 pt-2 bg-gradient-to-t from-gray-50 to-gray-200 dark:from-gray-950 dark:to-gray-900">
                <img src="/images/dash-light.webp" width="1440" height="1024" alt="product image" class="rounded-t-lg w-full h-auto dark:hidden">
                <img src="/images/dash-dark.webp" width="1440" height="1024" alt="product image" class="rounded-t-lg w-full h-auto hidden dark:flex">
            </div>
        </div>
    </div>
</section>
            ...
            <section className="min-h-max bg-purple-50 dark:bg-gray-950">
                ...
                <div className="w-full flex items-center relative">
                    ...
                    <div className="min-h-max relative mx-auto pt-32 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
                        <a href="#" className="flex items-center gap-x-2 text-gray-900 dark:text-gray-100 mx-auto w-max px-2 pr-1 py-1 rounded-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-800">
                            mySto v2.1 is out
                      ...
                      border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 rounded-full ease-linear focus-within:bg-white dark:focus-within:bg-gray-950  focus-within:border-puble-600">
                        ...
                        <div className="mx-auto max-w-6xl rounded-t-2xl aspect-[5/2.3] overflow-hidden px-2 pt-2 bg-gradient-to-t from-gray-50 to-gray-200 dark:from-gray-950 dark:to-gray-900">
                            <img src="/images/dash-light.webp" width={1440} height={1024} alt="product image" className="rounded-t-lg w-full h-auto dark:hidden" />
                            <img src="/images/dash-dark.webp" width={1440} height={1024} alt="product image" className="rounded-t-lg w-full h-auto hidden dark:flex" />
                        </div>
                    </div>
                </div>
            </section>
