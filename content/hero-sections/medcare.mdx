...
<header class="absolute inset-x-0 top-0 flex items-center h-20 z-40 pt-4 px-4">
    <nav
        ...
        <div class="flex items-center lg:hidden">
            <button data-toggle-navbar data-is-open="false" aria-label="Toggle navbar" class="outline-none border-l border-l-blue-100 dark:border-l-gray-800 pl-3 relative py-3 children:flex">
        ...
        <div class="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 relative">
            ...
            <div class="flex text-center lg:text-left flex-col lg:items-center lg:flex-row gap-8 lg:gap-10 xl:gap-12 relative max-w-4xl lg:max-w-none">
                ...
                <div aria-hidden="true" class="flex-1 lg:w-1/2 relative hidden lg:flex justify-end pr-8">
                    ...
                    <img src="/images/portrait-of-smiling-med.webp" width="3200" class="w-11/12 h-auto relative" alt="portrait-of-smiling-medical-worker-girl-doctor">
                </div>
            </div>
        </div>
    </section>
                ...
                <nav className="relative mx-auto lg:max-w-7xl w-full border border-gray-100 dark:border-gray-900 bg-white/70 dark:bg-gray-950 rounded-xl h-full px-4 flex gap-x-5 justify-between items-center">
                    ...
                    `}>
                        <ul className="flex flex-col lg:flex-row gap-6 lg:items-center text-gray-700 dark:text-gray-300 lg:flex-1 lg:justify-center">
                            <li>
                                <a href="#" className="duration-300 ease-linear hover:text-green-600 flex items-center gap-1.5 justify-between">
                                    Solutions
                                    <span>
                            ...
                            <li>
                                <a href="#" className="duration-300 ease-linear hover:text-green-600 ">Support</a>
                            </li>
                            <li>
                                <a href="#" className="duration-300 ease-linear hover:text-green-600 ">Company</a>
                            </li>
                        </ul>
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4  lg:min-w-max mt-10 lg:mt-0">
                            <a href="" className="px-6 h-10 text-sm flex items-center w-full lg:w-max justify-center gap-x-3 border border-gray-200 dark:border-gray-800 rounded-lg text-green-700 dark:text-gray-100 bg-gray-100 dark:bg-gray-900">
                                Book Demo
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="flex text-center lg:text-left flex-col lg:items-center lg:flex-row gap-8 lg:gap-10 xl:gap-12 relative max-w-4xl lg:max-w-none">
                            <div className="space-y-8 xl:space-y-10 lg:py-12 flex-1 lg:w-1/2">
                                <h1 className="text-green-950 dark:text-white text-3xl/tight sm:text-4xl/tight md:text-5xl/tight xl:text-6xl/tight font-bold">
                                    The only all in one <span className="text-transparent bg-clip-text bg-gradient-to-br from-green-700 to-sky-600">Tool</span> you need for your Clinic
                                </h1>
                                ...
                                <div className="flex flex-wrap items-center gap-4 z-30 sm:w-max sm:flex-nowrap mx-auto lg:mx-0">
                                    <a href="#" className="px-5 h-12 flex items-center sm:w-max w-full justify-center bg-gradient-to-br from-green-700 to-sky-600 text-white rounded-lg ease-linear transition">
                                        Get Started
                                    </a>
                                    <a href="" className="px-5 h-12 flex items-center sm:w-max w-full justify-center gap-x-3 border border-gray-200 dark:border-gray-900/60 rounded-lg text-green-800 dark:text-gray-100 bg-green-50 dark:bg-gray-900">
                                        <span>
                            ...
                            <div aria-hidden="true" className="flex-1 lg:w-1/2 relative hidden lg:flex justify-end pr-8">
                                ...
                                <img src="/images/portrait-of-smiling-med.webp" width={3200} className="w-11/12 h-auto relative" alt="portrait-of-smiling-medical-worker-girl-doctor" />
                            </div>
                        </div>
                    </div>
                </section>
