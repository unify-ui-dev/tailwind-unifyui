...
<section class="min-h-max bg-blue-50 dark:bg-gray-950">
    ...
    <div class="min-h-max h-[100dvh] w-full flex items-center relative">
        <div
            class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-2/5 aspect-[2/0.5] bg-gradient-to-br from-blue-600 to-pink-400 rounded-full opacity-50 blur-2xl">
        </div>
        <div
            class="relative mx-auto pt-32 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
            <h1
                class="text-gray-900 dark:text-white mx-auto max-w-4xl font-bold text-4xl/tight sm:text-5xl/tight lg:text-6xl/tight xl:text-7xl/tight">
            ...
            <div class="flex sm:flex-row flex-col gap-5 w-full mx-auto max-w-xl">
                <form action="#"
                    ...
                    <button
                        class="flex text-white justify-center items-center w-max min-w-max sm:w-max px-6 h-12 rounded-lg outline-none relative overflow-hidden border duration-300 ease-linear
                ...
                <div className="min-h-max h-[100dvh] w-full flex items-center relative">
                    ...
                    <div className="relative mx-auto pt-32 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
                      ...
                      border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 rounded-xl ease-linear focus-within:bg-white dark:focus-within:bg-gray-950  focus-within:border-blue-600">
                        ...
                        <div className="flex items-center gap-1 mt-10 justify-center gap-x-3">
                            <div className="flex items-center -space-x-2">
                                <Image src="/images/podCast.webp" height={1800} width={2250} alt="listener avatar" className="w-10 h-10 object-cover rounded-full ring-4 ring-white dark:ring-gray-950" />
                                <Image src="/images/podCast.webp" height={1800} width={2250} alt="listener avatar" className="w-10 h-10 object-cover rounded-full ring-4 ring-white dark:ring-gray-950" />
                                <Image src="/images/podCast.webp" height={1800} width={2250} alt="listener avatar" className="w-10 h-10 object-cover rounded-full ring-4 ring-white dark:ring-gray-950" />
                            </div>
                            <div className="flex flex-col justify-start items-start">
